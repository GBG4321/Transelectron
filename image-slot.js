...
(() => {
  ...
  const stylesheet =
    ...
    // touch-action:none only while a drag-to-reframe gesture is actually
    // possible (editor, reframe mode) — otherwise a visitor's finger landing
    // on a photo would block the page's normal scroll gesture.
